...
param regionCode = 'test'

// Backend image hosted in GHCR (adjust owner/repo:tag)
param containerImage = 'ghcr.io/OWNER/softball-digital-sign-server:test'
...
param corsOrigin = 'https://softball-digisign-swa-test.azurestaticapps.net'
